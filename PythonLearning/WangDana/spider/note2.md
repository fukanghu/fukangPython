...
- 官方文档：www.w3school.com.cn/xpath/index.asp
- XPath开发工具
    - 开源的XPath表达式工具：XMLQuire
    - chrime插件：XPath Helper
...
- 谓语(Predicates)
    ...
    - /bookstore/book[@lang]:选取属于bookstore下叫book的元素，含有属性lang元素
    - /bookstore/book[@lang="cn"]:选取属于bookstore下叫book的元素，含有属性lang的值是cin的元素
    - /bookstore/book[@price < 90]:选取属于bookstore下叫book的元素，含有属性price的，且值小于90的元素
    - /bookstore/book[@price < 90]/title:选取属于bookstore下叫book的元素，含有属性price的，且小于90的元素的子元素title
...
- 现在使用BeautifulSoup4
- http://beautifulsoup.readthedocx.io/zh_CN/v4.4.0/
- 几个常用提取信息工具的比较
    - 正则：很快，不好用，不许安装
